...
public class ThrowingKnife extends Weapon implements RangeWeapon, MeleeWeapon {
    ...
    private double range;   // Räckvidd för kniven

    // Konstruktor
    public ThrowingKnife(String name, int damage, double weight, int durability, int ammunition, double range) {
        super(name, damage, weight, durability, ammunition); // Skicka alla argument som Weapon-konstruktorn förväntar sig
    ...
    // Implementera meleeAttack och slashAttack
    @Override
    ...
    // Implementera den abstrakta metoden unequipItem från Weapon
    @Override
